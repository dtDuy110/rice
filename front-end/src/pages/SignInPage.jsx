      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-8 right-8">
          <h2 className="text-white text-4xl font-bold leading-tight mb-4" style={{ fontFamily: 'var(--font-family-heading)' }}>
            Tận hưởng hương vị tinh túy, gìn giữ truyền thống.
          </h2>
          <p className="text-white/80 text-body-lg">
            Kết nối nông sản hữu cơ cao cấp với những người yêu chất lượng.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-surface-container-lowest p-8">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-body-md text-on-surface-variant text-sm">Ghi nhớ đăng nhập</span>
              </label>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-label-sm text-outline uppercase tracking-wider">Hoặc tiếp tục với</span>
            <div className="flex-1 h-px bg-outline-variant/30" />
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="flex items-center justify-center gap-2 border border-outline-variant/50 rounded-xl py-3 text-label-md hover:bg-surface-container-high transition-colors font-medium">
