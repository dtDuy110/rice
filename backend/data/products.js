const products = [
  {
    ...
    price: 35.00,
    images: ['/images/product-detail-rice.png', '/images/jasmine-rice.png'],
    category: 'Gạo ST',
    ...
    organic: true,
    features: [
      'Đạt giải Gạo ngon nhất thế giới 2019',
      'Hương thơm lá dứa tự nhiên',
      'Hạt dài, trắng trong, cơm dẻo mềm',
  ...
  },
  {
    ...
    price: 28.00,
    images: ['/images/jasmine-rice.png'],
    category: 'Gạo ST',
    origin: 'Sóc Trăng, Việt Nam',
    weight: '5 kg',
    sku: 'TP-ST24-02',
  ...
  },
  {
    ...
    price: 24.00,
    images: ['/images/product-detail-rice.png', '/images/jasmine-rice.png', '/images/brown-rice.png'],
    category: 'Gạo Jasmine',
    origin: 'Việt Nam',
    weight: '5 kg',
    sku: 'TP-JAS-03',
    unit: 'kg',
  ...
  },
  {
    ...
    price: 36.00,
    images: ['/images/product-detail-rice.png'],
    category: 'Gạo Thơm',
